...
public:
	...
	static Matrix_f32 MultiplayMatrixWithScalar(const Matrix_f32 &mat1, const double scalar);    
    ...
    static Matrix_f32 MultiplayMatrixWithScalarVectorized(const Matrix_f32 &mat1, const double scalar); //Incomplete.
...
protected:
	...
	static Matrix_f32 GausJordanElimination(const Array2D & sourceMat);
};